...
class AddedToken(BaseModel):
    ...
    ----------
        ...
        single_word (bool): Indicates if the token is a single word.
        ...
        lstrip (bool): If True, the token will be stripped from the left side.
        rstrip (bool): If True, the token will be stripped from the right side.
        normalized (bool): If True, the token form is searched _before_ normalization and pretokenization happens.
        ...
        special (bool): If True, the token is a special token.
        ...
        id (int): The unique identifier for the token.
            The token index in the vocabulary.
